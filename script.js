...
let API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyDOMkAxl2w17VMKzSz0jgBHUAY6aRUkiEM";
...
voiceBtn.addEventListener("click", () => {
    ...
    voiceVisual.style.display = "block"; // Show animation
    ...
    recognition.onresult = (event) => {
        ...
        voiceVisual.style.opacity = "0"; // Hide animation after input
        setTimeout(() => {
...
async function fetchResponse(message) {
    try {
        ...
        console.log(response.status); // Check if the response status is OK (200)
